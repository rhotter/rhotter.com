...
<figcaption>
  <b>
        Knee MRI comparison between VarNet and the ground truth at 4x
        acceleration.
      </b>{" "}
      Figure reproduced from{" "}
      <a href="https://www.ajronline.org/doi/10.2214/AJR.20.23313">
        Recht et al. 2020
      </a>
      .
    </figcaption>
...
<figcaption>
        Comparison of the untrained{" "}
        <a href="http://arxiv.org/abs/2007.02471">ConvDecoder</a> with the{" "}
        <a href="http://arxiv.org/abs/1811.08839">U-Net MRI</a>, and
        total-variation regularized compressed sensing.** Reconstructions of
        knee-MRI at 4x acceleration. The second row is a zoomed in version of the
