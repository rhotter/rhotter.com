...
_I would love if you added comments! I absolutely loved the discussion on my last set of notes. You can add comments using the [Curius](https://curius.app) chrome extension.[^1]_
