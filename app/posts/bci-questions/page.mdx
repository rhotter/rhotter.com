...
35. Is there a limit to the number of electrodes you can put in the brain?
    ...
    - Heating — electrodes themselves shouldn’t produce any Joule heating since there is no current (0 = ∆V = I R between the contact point and the measurement point). But amplifiers, analog to digital converters, and RF transmitters produce heat (why?)
